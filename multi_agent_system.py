...
- AMMONIA CONTEXT (Day 5+ ONLY): At Day 5+, if grade 3-4 HE has normal ammonia (<50 umol/L) AND an alternative explanation exists, the HE override does NOT apply. Before Day 5, normal ammonia does NOT rule out cerebral edema.
