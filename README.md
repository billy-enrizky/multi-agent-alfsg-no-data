...
graph TD;
    ...
    B -- "3. Analyze Trend Time Series Data \n (e.g., INR: 3.5 (Rapidly increasing from 2.0 in 6d), <br> incorporating Rate of Change)" --> C;
    ...
    subgraph "⚖️ Final Synthesis"
        ...
        J -- "Applies weighting logic \n (e.g., Critical Care=40%, Surgeon=30%, Hepatologist=30%)" --> K("Weighted Analysis & Prediction");
    end

    K --> L["Final Prediction (Day `i`): \n Patient Survival in 21 Days? \n (Yes/No)"];
